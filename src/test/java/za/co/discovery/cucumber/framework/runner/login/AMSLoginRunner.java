...
@CucumberOptions(features = {"classpath:featurefile/login/AMS_StartToEnd.feature"
...
public class AMSLoginRunner extends AbstractTestNGCucumberTests {
	...
	public static void setup() {
		...
		extentProperties.setReportPath("C:/Users/abhijit1/Documents/output/AMS_StartToEnd_"+String.valueOf(dtf.format(now))+".html");
