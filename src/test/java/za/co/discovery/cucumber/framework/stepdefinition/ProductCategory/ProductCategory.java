package za.co.discovery.cucumber.framework.stepdefinition.ProductCategory;

import cucumber.api.java.en.Given;
import cucumber.api.java.en.Then;
import org.apache.log4j.Logger;
import org.testng.Assert;
import za.co.discovery.cucumber.framework.PageObject.HomePage;
import za.co.discovery.cucumber.framework.PageObject.ProductCategoryPage;
...
public class ProductCategory {
	...
	public void user_click_on_women_navigation_menu() throws Throwable {
	   ...
	   productCategoryPage = homepage.clickOnMenu(homepage.login);
	}
